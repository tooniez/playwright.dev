...
**Returns**
- [IEnumerable]&lt;[Locator]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-all-return"/><a href="#locator-all-return" class="list-anchor">#</a>
...
- `options` `LocatorFilterOptions?` *(optional)*
  ...
  - `HasNot` [Locator]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-filter-option-has-not"/><a href="#locator-filter-option-has-not" class="list-anchor">#</a>
    ...
    Note that outer and inner locators must belong to the same frame. Inner locator must not contain [FrameLocator]s.
  - `HasNotText|HasNotTextRegex` [string]? | [Regex]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-filter-option-has-not-text-has-not-text-regex"/><a href="#locator-filter-option-has-not-text-has-not-text-regex" class="list-anchor">#</a>
    
    Matches elements that do not contain specified text somewhere inside, possibly in a child or a descendant element. When passed a [string], matching is case-insensitive and searches for a substring.
  - `HasText|HasTextRegex` [string]? | [Regex]? *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-filter-option-has-text-has-text-regex"/><a href="#locator-filter-option-has-text-has-text-regex" class="list-anchor">#</a>
...
- `options` `LocatorGetByRoleOptions?` *(optional)*
  ...
  - `Name|NameRegex` [string]? | [Regex]? *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-get-by-role-option-name-name-regex"/><a href="#locator-get-by-role-option-name-name-regex" class="list-anchor">#</a>
...
- `options` `LocatorLocatorOptions?` *(optional)*
  ...
  - `HasNot` [Locator]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-locator-option-has-not"/><a href="#locator-locator-option-has-not" class="list-anchor">#</a>
    ...
    Note that outer and inner locators must belong to the same frame. Inner locator must not contain [FrameLocator]s.
  - `HasNotText|HasNotTextRegex` [string]? | [Regex]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-locator-option-has-not-text-has-not-text-regex"/><a href="#locator-locator-option-has-not-text-has-not-text-regex" class="list-anchor">#</a>
    
    Matches elements that do not contain specified text somewhere inside, possibly in a child or a descendant element. When passed a [string], matching is case-insensitive and searches for a substring.
  - `HasText|HasTextRegex` [string]? | [Regex]? *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-locator-option-has-text-has-text-regex"/><a href="#locator-locator-option-has-text-has-text-regex" class="list-anchor">#</a>
